...
/**
 * Smoke test: GuidedTour loads, the flow picker renders, and the Blazor circuit
 * becomes interactive (primary button enabled). Proves the toolchain + server
 * lifecycle + circuit-wait helper end-to-end before the full specs are added.
 */
